...
type Battery2 struct {
	...
	CurrentBattery int16  // Battery current, in centiamperes (1 = 10 milliampere), -1: autopilot does not measure the current
}
...
type Deepstall struct {
	LandingLat             int32   // Landing latitude (deg * 1E7)
	LandingLon             int32   // Landing longitude (deg * 1E7)
	PathLat                int32   // Final heading start point, latitude (deg * 1E7)
	PathLon                int32   // Final heading start point, longitude (deg * 1E7)
	ArcEntryLat            int32   // Arc entry point, latitude (deg * 1E7)
	ArcEntryLon            int32   // Arc entry point, longitude (deg * 1E7)
	...
	CrossTrackError        float32 // Deepstall cross track error in meters (only valid when in DEEPSTALL_STAGE_LAND)
	Stage                  uint8   // Deepstall stage, see enum MAV_DEEPSTALL_STAGE
}
